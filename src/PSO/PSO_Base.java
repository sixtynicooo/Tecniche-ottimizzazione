...
public class PSO_Base {
    ...
    static classi_condivise.PARTICELLA_PSO_Base[] listaIndividui;    // lista individui
    static classi_condivise.PARTICELLA_PSO_Base globalFitnessMIgliore;    // lista individui
    ...
    public PSO_Base(int NUM_INDIVIDUO, long ITERAZIONI, long STAZIONARIETA, int DIM_ARR_DOUBLE, double[] ARR_DOUBLE, double[] ARR_DOUBLE_MIN, double[] ARR_DOUBLE_MAX, double w, double c1, double c2) {
        PSO_Base.NUM_INDIVIDUO = NUM_INDIVIDUO;
        PSO_Base.ITERAZIONI = ITERAZIONI;
        PSO_Base.STAZIONARIETA=STAZIONARIETA;
        PSO_Base.DIM_ARR_DOUBLE = DIM_ARR_DOUBLE;
        PSO_Base.ARR_DOUBLE_MIN = ARR_DOUBLE_MIN;
        PSO_Base.ARR_DOUBLE_MAX = ARR_DOUBLE_MAX;
    ...
    private void inizializza() {
        ...
        listaIndividui = new classi_condivise.PARTICELLA_PSO_Base[NUM_INDIVIDUO];
           globalFitnessMIgliore= new classi_condivise.PARTICELLA_PSO_Base(DIM_ARR_DOUBLE, ARR_DOUBLE_MIN, ARR_DOUBLE_MAX); // Crea un nuovo individuo
        // Inizializzazione degli individui
        for (int i = 0; i < NUM_INDIVIDUO; i++) {
            listaIndividui[i] = new classi_condivise.PARTICELLA_PSO_Base(DIM_ARR_DOUBLE, ARR_DOUBLE_MIN, ARR_DOUBLE_MAX); // Crea un nuovo individuo
