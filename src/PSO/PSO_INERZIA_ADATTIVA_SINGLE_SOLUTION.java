...
public class PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION {
    ...
    public PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION(int NUM_INDIVIDUO, long ITERAZIONI, long STAZIONARIETA,
            ...
            double[] w_ARR_DOUBLE_MAX, double c1, double c2,boolean problemaMassimizzareMinimizzare) {
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.problemaMassimizzareMinimizzare = problemaMassimizzareMinimizzare;

        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.NUM_INDIVIDUO = NUM_INDIVIDUO;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.ITERAZIONI = ITERAZIONI;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.STAZIONARIETA = STAZIONARIETA;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.DIM_ARR_DOUBLE = DIM_ARR_DOUBLE;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.ARR_DOUBLE_MIN = ARR_DOUBLE_MIN;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.ARR_DOUBLE_MAX = ARR_DOUBLE_MAX;

        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.w_ARR_DOUBLE = w_ARR_DOUBLE;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.w_ARR_DOUBLE_MIN = w_ARR_DOUBLE_MIN;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.w_ARR_DOUBLE_MAX = w_ARR_DOUBLE_MAX;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.c1 = c1;
        PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION.c2 = c2;
    ...
    private void inizializza() {
        ...
        listaIndividui = new classi_condivise.PARTICELLA_PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION[NUM_INDIVIDUO];
        globalFitnessMIgliore = new classi_condivise.PARTICELLA_PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION(DIM_ARR_DOUBLE, ARR_DOUBLE_MIN, ARR_DOUBLE_MAX); // Crea un nuovo individuo
        // Inizializzazione degli individui
        for (int i = 0; i < NUM_INDIVIDUO; i++) {
            listaIndividui[i] = new classi_condivise.PARTICELLA_PSO_INERZIA_ADATTIVA_SINGLE_SOLUTION(DIM_ARR_DOUBLE, ARR_DOUBLE_MIN, ARR_DOUBLE_MAX); // Crea un nuovo individuo
